            ...
            <form class="form-horizontal" action="{{ route('users.update',['user' => $user->id] )}}" method="POST">
                ...
                <div class="box-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" value="{{$user->name}}" name="name" class="form-control @error('name') is-invalid @enderror" id="inputName" placeholder="Nome">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputEmail" class="col-sm-2 col-form-label">Email</label>
                        <div class="col-sm-10">
                            <input type="email" value="{{$user->email}}" name="email" class="form-control @error('email') is-invalid @enderror" id="inputEmail" placeholder="Email">
                        </div>
                    </div>
                    <div class="form-group row">
                ...
                <div class="box-footer form-group row text-right">
                        ...
                        <div class="col-sm-10">
                            ...
                            <button type="submit" class="btn btn-sm btn-success pull-right">Atualizar</button>
                        </div>
                </div>
            <!-- /.box-footer -->
            </form>
